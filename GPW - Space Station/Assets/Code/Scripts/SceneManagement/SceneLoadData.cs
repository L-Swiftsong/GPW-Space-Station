...
namespace SceneManagement
{
    public struct HardLoadData
    {
        ...
        public HardLoadData(SceneField[] scenesToLoad, string activeSceneName, SceneField[] scenesToForceUnload)
        {
        ...
        public HardLoadData(SceneField[] scenesToLoad, string activeSceneName, SceneField[] scenesToForceUnload, Vector3 entryPosition, float entryRotation)
        {
            this.ScenesToLoad = scenesToLoad;
            this.ActiveSceneName = activeSceneName;
            this.ScenesToForceUnload = scenesToForceUnload;
